...
(library Library_1
	...
	(compDef "NJM7805SDL1-TE1" (originalName "NJM7805SDL1-TE1") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(attr "RS Part Number" "2444523P")
		(attr "RS Price/Stock" "http://uk.rs-online.com/web/p/products/2444523P")
		...
		(attr "Datasheet Link" "http://uk.rs-online.com/web/p/products/2444523P")
	)
